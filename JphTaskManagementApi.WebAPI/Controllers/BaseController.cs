...
namespace JphTaskManagementApi.WebAPI.Controllers
{
    ...
    public class BaseController : Controller
    {
        ...
        protected readonly ITasksService _tasksService;
        ...
        public BaseController(IServiceProvider serviceProvider, IOptions<SectionConfiguration> configuration)
        {
            ...
            _tasksService = serviceProvider.GetService(typeof(ITasksService)) as ITasksService;
            _statesService = serviceProvider.GetService(typeof(IStatesService)) as IStatesService;
        }
